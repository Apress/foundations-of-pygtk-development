...
class AppWindow(Gtk.ApplicationWindow):
    ...
    def create_popup_menu(self, menu, progress):
        ...
        pulse.add_accelerator("activate", group, Gdk.KEY_P, Gdk.ModifierType.CONTROL_MASK, 
                              Gtk.AccelFlags.VISIBLE)
        fill.add_accelerator("activate", group, Gdk.KEY_F, Gdk.ModifierType.CONTROL_MASK, 
                             Gtk.AccelFlags.VISIBLE)
        clear.add_accelerator("activate", group, Gdk.KEY_C, Gdk.ModifierType.CONTROL_MASK, 
                             Gtk.AccelFlags.VISIBLE)
